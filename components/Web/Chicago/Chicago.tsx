...
const backgrounds = ["/images/home-bg-2.png", "/images/home-bg.png"];
...
export default function Chicago() {
  ...
  return (
    <section
      ...
      <div className='custom-container min-h-screen flex flex-col gap-16 justify-between pt-8 lg:pt-12 pb-30 sm:pb-8'>
        {/* Heading */}
        <div className='flex flex-col gap-4 text-center max-w-[850px] w-full mx-auto'>
          <h1 className='text-[25px] leading-[130%] md:text-[42px] md:leading-normal font-semibold text-white'>
            Drive Your Dream{" "}
            <span className='text-Primary-Color'>Luxury SUV</span> Today – Fast
            & Easy Auto Leasing in{" "}
            <span className='text-Primary-Color'>Chicago</span>
          </h1>

          <div className='flex flex-wrap justify-center md:justify-between items-center gap-2'>
            <p className='flex items-center gap-2'>
              <GoDotFill className='text-Primary-Color w-6 h-6' />
